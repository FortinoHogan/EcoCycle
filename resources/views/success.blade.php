        ...
        <div class="mx-auto max-w-2xl px-4 2xl:px-0">
            ...
            <div
                ...
                <dl class="sm:flex items-center justify-between gap-4">
                    ...
                    <dd class="font-medium text-gray-900 dark:text-white sm:text-end">{{ $transaction->payment_type }}
                        {{ $transaction->va_numbers[0]['bank'] }}</dd>
                </dl>
                <dl class="sm:flex items-center justify-between gap-4">
                ...
                <dl class="sm:flex items-center justify-between gap-4">
                    ...
                    <dd class="font-medium text-gray-900 dark:text-white sm:text-end">{{ $address->street }}, {{ $address->subdistrict }}, {{ $address->city }}, {{ $address->province }}, {{ $address->postal_code }}</dd>
                </dl>
                <dl class="sm:flex items-center justify-between gap-4">
            ...
            <div class="flex items-center space-x-4">
                <a href="{{ route('shop.view') }}"
                    class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800">Return to Shopping</a>
            </div>
        </div>
    </section>
@endsection
