...
@section('konten')
            ...
            <form action="{{ route('login_buyer.post') }}" class="pt-4" method="POST">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <label for="floating_email"
                        class="peer-focus:font-medium absolute text-sm text-gray-200 dark:text-accent duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-accent peer-focus:dark:text-accent peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Email address</label>
                </div>
                ...
                <div class="flex justify-center mt-16">
                    <button type="submit"
                        class="w-full text-[#3C552D] bg-white font-medium py-2 rounded-md hover:text-[#3C552D] hover:bg-gray-400 transition-all duration-500">Log In</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="flex flex-col items-center pt-6 mb-20">
        <a href="{{ route('sellerLogin.view') }}" class="text-xl text-[#EB5B00] font-semibold mb-4 hover:text-gray-400 transition-all duration-500">Login to your Seller account</a>
        <span class="text-[#3C552D] text-lg font-medium">Doesn't have an account? <a href="{{ route('buyerRegister.view') }}" class=" hover:text-gray-400 transition-all duration-500">Create a EcoCycle Account</a></span>
    </div>
@endsection
