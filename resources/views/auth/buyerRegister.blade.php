...
@section('konten')
    ...
    <div class="flex flex-col items-center justify-center pt-6 mb-20">
        <a href="{{ route('sellerRegister.view') }}" class=" text-xl text-[#EB5B00] font-semibold mb-4 hover:text-gray-500 transition-all duration-500">Register your Seller account</a>
